      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
        <div className="lg:col-span-1">
          <Link href="/" className="inline-block mb-4 hover:opacity-80 transition-opacity">
            <Image src="/images/logoo.png" alt="Pháp Môn Tâm Linh" width={48} height={48} className="h-12 w-auto object-contain" />
          </Link>
        ...
        <div>
          <h4 className="text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4">Các Trang</h4>
        ...
        <div>
          <h4 className="text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4">Tải Xuống Miễn Phí</h4>
          <ul className="space-y-2">
            {downloadLinks.map((l) => (
              <li key={l.label}>
        ...
        <div>
          <h4 className="text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4">Liên Hệ & Đường Dẫn</h4>
          ...
          <div className="pt-3 border-t border-border/50 space-y-1">
            <p className="text-xs text-muted-foreground/70">2A Holden Street, Ashfield</p>
            <p className="text-xs text-muted-foreground/70">NSW 2131, Australia</p>
            <a href="tel:+61292832758" className="text-xs text-muted-foreground/70 hover:text-gold transition-colors block">
              +61 2 9283 2758
            </a>
            <a href="mailto:oriental2or@hotmail.com" className="text-xs text-muted-foreground/70 hover:text-gold transition-colors block">
              oriental2or@hotmail.com
            </a>
          </div>
        </div>
      </div>
